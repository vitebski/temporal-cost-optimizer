...
> [!WARNING]
> **Temporal Cloud API limitation**
>
> Temporal Cloud APIs do not currently allow reading workflow and execution data directly from a namespace. Namespaces that require mTLS authentication also are not supported by this demo.
